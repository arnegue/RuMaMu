...
mod tests_seatalk36 {
    use rumamu::seatalk::{
        ...
        seatalk_36::Sentence36,
    };

    const TEST_DATA: [u8; 3] = [0x36, 0x00, 0x01];
    ...
    fn test_seatalk_parsing() {
        ...
        let result: Result<Sentence36, ParseError> =
            Sentence36::parse_seatalk_data(test_buffer, Sentence36::LENGTH);
        match result {
            Ok(_) => {}
    ...
    fn test_seatalk_creation() {
        ...
        let seatalk_sentence = Sentence36 {};
    ...
    fn test_message_length() {
        ...
        let wrong_length: usize = Sentence36::LENGTH + 1;
        let test_buffer: [u8; MAX_SEATALK_LENGTH] = [Sentence36::ID; MAX_SEATALK_LENGTH];
        let result: Result<Sentence36, ParseError> =
            Sentence36::parse_seatalk_data(test_buffer, wrong_length);
        match result {
    ...
    fn test_message_id() {
        ...
        let wrong_id: u8 = Sentence36::ID + 1;
        let test_buffer: [u8; MAX_SEATALK_LENGTH] = [wrong_id; MAX_SEATALK_LENGTH];
        let result: Result<Sentence36, ParseError> = Sentence36::parse_seatalk_data(test_buffer, 5);
        match result {
